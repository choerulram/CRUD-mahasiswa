...
<body>
	...
	$id = $_GET['id'];
	$data = mysqli_query($koneksi,"select * from mata_kuliah where id='$id'");
    ...
    <form method="post" action="update.php">
        <div class="container border p-5 bg-light rounded">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="kode_mk" value="<?php echo $d['kode_mk']; ?>" id="exampleFormControlInput1" placeholder="Masukkan kode mata kuliah..." required/>
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"><b>Nama Mata Kuliah</b></label>
                <input type="text" class="form-control" name="nama_mk" value="<?php echo $d['nama_mk']; ?>" id="exampleFormControlInput1" placeholder="Masukkan nama mata kuliah..." required/>
            </div>
            <div class="mb-3 w-25">
				...
				<select class="form-select w-75" aria-label="Default select example" name="semester" required>
                    <option value="<?php echo $d['semester']; ?>" selected disabled>Pilih Semester</option>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="jumlah_sks" value="<?php echo $d['jumlah_sks']; ?>" id="exampleFormControlInput1" placeholder="Masukkan jumlsh sks..." required/>
            </div>
