	...
	?>
		...
		<form method="post" action="update.php">
			<div class="container border p-5 bg-light rounded">
				...
				<div class="mb-3">
					<label for="exampleFormControlInput1" class="form-label"><b>Program Studi</b></label>
					<input type="text" name="program_studi" value="<?php echo $d['program_studi']; ?>" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan program studi..." required/>
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="text" name="tempat_lahir" value="<?php echo $d['tempat_lahir']; ?>" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan tempat lahir..." required/>
				</div>
				<div class="mb-3 w-25">
					<label for="exampleFormControlInput1" class="form-label"><b>Tanggal Lahir</b></label>
					<input type="date" name="tanggal_lahir" value="<?php echo $d['tanggal_lahir']; ?>" class="form-control" id="exampleFormControlInput1" required/>
				</div>
				<div class="mb-3">
					<label for="exampleFormControlInput1" class="form-label"><b>Jenis Kelamin</b></label><br/>
					<input type="radio" id="laki_laki" name="jenis_kelamin" value="Laki-Laki" required <?php echo $d['jenis_kelamin']; ?>/>
					<label for="laki_laki">Laki-laki</label>
					<input type="radio" id="perempuan" name="jenis_kelamin" value="Perempuan" required <?php echo $d['jenis_kelamin']; ?>/>
				...
				<div class="mb-3 w-25">
					...
					<select class="form-select w-75" aria-label="Default select example" name="agama" required>
						<option value="<?php echo $d['agama']; ?>" selected disabled>Pilih Agama</option>
				...
				<div class="mb-3">
					...
					<input type="file" class="form-control" id="exampleFormControlInput1" name="foto" value="<?php echo $d['foto']; ?>"/>
				</div>
